...
const filtrationStorageDoc: StepDefinitionSeed = {
  ...
  schema: {
    input_mode: "matrix",
    columns: [
      { key: "filter_size", label_he: "גודל הפילטר", label_en: "Filter size", field_type: "text", required: false },
      { key: "storage_vessel_no", label_he: "מספר מיכל אחסון", label_en: "Storage vessel number", field_type: "text", required: false },
      {
...
const packagingUltraStorage: StepDefinitionSeed = {
  ...
  schema: {
    input_mode: "matrix",
    columns: [
      { key: "ultra_vessel", label_he: "מיכל אולטרה", label_en: "Ultra-clean vessel", field_type: "text", required: false },
      {
        key: "product_temp_in_vessel",
...
const packagingBbGrid: StepDefinitionSeed = {
  ...
  schema: {
    input_mode: "matrix",
    columns: [
      { key: "col_godel_ariza", label_he: "גודל אריזה", label_en: "Package size", field_type: "text", required: false },
      { key: "col_hataamat_ariza", label_he: "התאמת אריזה למוצר", label_en: "Package match to product", field_type: "text", required: false },
...
const ccp3LabVerification: StepDefinitionSeed = {
  ...
  schema: {
    ...
    fields: [
      ...
      { key: "temp", label_he: "טמפ'", label_en: "Temperature", field_type: "temperature", required: false, unit: "°C" },
      { key: "weight", label_he: "משקל", label_en: "Weight", field_type: "number", required: false },
      { key: "name_and_signature", label_he: "שם וחתימה", label_en: "Name and signature", field_type: "text", required: false },
      {
...
const packagingCarton1kg: StepDefinitionSeed = {
  ...
  schema: {
    ...
    columns: [
      { key: "col_mispar_atsvot_karton", label_he: "מספר אצוות קרטון", label_en: "Carton batch nos.", field_type: "text", required: false },
      { key: "col_ishur_hataama", label_he: "אישור התאמת אריזה למוצר", label_en: "Package fit approval", field_type: "text", required: false },
      { key: "col_mispar_atsvot_balon", label_he: "מספר אצוות בלון גז", label_en: "Gas cylinder batch nos.", field_type: "text", required: false },
      { key: "col_lishimush_ad", label_he: "לשימוש עד", label_en: "Use by", field_type: "date", required: false },
