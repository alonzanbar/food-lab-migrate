...
-- Catalog sha256: c3d84d2beef009265be7021df52f47f69f8f3cf32d0320a09a9df6aa8328f0ab
...
VALUES (
  ...
  NULL,
  'matrix'::public.input_mode,
  '{"input_mode":"matrix","columns":[{"key":"material_name","label_he":"שם החומר","label_en":"Material name","field_type":"select","required":false,"options":["Salt","Sugar","Xanthan (קסנטן)"]},{"key":"quantity_kg","label_he":"כמות בק\"ג","label_en":"Quantity (kg)","field_type":"number","required":false},{"key":"raw_lot","label_he":"אצווה","label_en":"Lot","field_type":"text","required":false},{"key":"worker_name_sig","label_he":"שם וחתימת עובד","label_en":"Employee name and signature","field_type":"text","required":false}]}'::jsonb,
  true,
  NULL
)
ON CONFLICT (id) DO UPDATE SET
