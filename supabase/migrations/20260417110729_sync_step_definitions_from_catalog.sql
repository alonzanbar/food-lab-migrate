...
-- Catalog sha256: 527f5db7f2836602877f59a4bc61de2b989181501b7d2b19720e4aefb3054174
...
VALUES (
  ...
  NULL,
  'matrix'::public.input_mode,
  '{"input_mode":"matrix","columns":[{"key":"material_name","label_he":"שם החומר","label_en":"Material name","field_type":"select","required":false,"options":["Salt","Sugar","Xanthan (קסנטן)"]},{"key":"quantity_kg","label_he":"כמות בק\"ג","label_en":"Quantity (kg)","field_type":"number","required":false},{"key":"raw_lot","label_he":"אצווה","label_en":"Lot","field_type":"text","required":false},{"key":"worker_name_sig","label_he":"שם וחתימת עובד","label_en":"Employee name and signature","field_type":"name_and_signature","required":false}]}'::jsonb,
  true,
  NULL
)
ON CONFLICT (id) DO UPDATE SET
...
VALUES (
  ...
  NULL,
  'matrix'::public.input_mode,
  '{"input_mode":"matrix","columns":[{"key":"filter_size","label_he":"גודל הפילטר","label_en":"Filter size","field_type":"select","required":false,"options":["0.6","0.9"]},{"key":"storage_vessel_no","label_he":"מספר מיכל אחסון","label_en":"Storage vessel number","field_type":"select","required":false,"options":["1","2","3","4"]},{"key":"product_temp_in_vessel","label_he":"טמפ'' המוצר במיכל","label_en":"Product temperature in vessel","field_type":"temperature","required":false,"unit":"°C"},{"key":"quantity_in_vessel","label_he":"כמות במיכל","label_en":"Quantity in vessel","field_type":"number","required":false}]}'::jsonb,
  true,
  NULL
)
ON CONFLICT (id) DO UPDATE SET
...
VALUES (
  ...
  NULL,
  'single_form'::public.input_mode,
  '{"input_mode":"single_form","fields":[{"key":"ph","label_he":"pH","label_en":"pH","field_type":"number","required":false},{"key":"brix","label_he":"בריקס","label_en":"Brix","field_type":"number","required":false},{"key":"taste","label_he":"טעם","label_en":"Taste","field_type":"select","required":false,"options":["Approved","Not approved"]},{"key":"smell","label_he":"ריח","label_en":"Smell","field_type":"select","required":false,"options":["Approved","Not approved"]},{"key":"foaming_approval","label_he":"אישור לפני הקצפה","label_en":"Approval before foaming","field_type":"select","required":false,"options":["Approved","Not approved"]},{"key":"approval_name","label_he":"שם המאשר","label_en":"Approver name","field_type":"text","required":false},{"key":"lab_qa_approval","label_he":"אישור מעבדה/מ. איכות","label_en":"Lab / QA approval","field_type":"text","required":false}]}'::jsonb,
  false,
  NULL
)
ON CONFLICT (id) DO UPDATE SET
...
VALUES (
  ...
  NULL,
  'matrix'::public.input_mode,
  '{"input_mode":"matrix","columns":[{"key":"pasteurizer_no","label_he":"מס'' מפסטרת","label_en":"Pasteurizer no.","field_type":"integer","required":false,"validation":{"auto_row_index":true}},{"key":"pump_flow","label_he":"ספיקת משאבת פיסטור","label_en":"Pasteurization pump flow","field_type":"text","required":false},{"key":"manifold_pressure","label_he":"לחץ המגוון","label_en":"Manifold pressure","field_type":"text","required":false},{"key":"pasteur_temp","label_he":"טמפ'' פסטור","label_en":"Pasteurization temperature","field_type":"temperature","required":false,"unit":"°C"},{"key":"reversal_temp","label_he":"טמפ'' \"רוורסיה\"","label_en":"Reversal temperature","field_type":"temperature","required":false,"unit":"°C"}]}'::jsonb,
  true,
  NULL
)
ON CONFLICT (id) DO UPDATE SET
...
VALUES (
  ...
  NULL,
  'single_form'::public.input_mode,
  '{"input_mode":"single_form","fields":[{"key":"pasteur_start_time","label_he":"שעת תחילת פסטור","label_en":"Pasteurization start time","field_type":"time","required":false},{"key":"pressure_1h_after_start","label_he":"לחץ — שעה מתחילת פסטור","label_en":"Pressure — 1h after start","field_type":"pressure","required":false},{"key":"pressure_2h_after_start","label_he":"לחץ — שעתיים מתחילת פסטור","label_en":"Pressure — 2h after start","field_type":"pressure","required":false},{"key":"exit_temp_1h_after_start","label_he":"טמפ'' יציאה — שעה מתחילת פסטור","label_en":"Exit temperature — 1h after start","field_type":"temperature","required":false,"unit":"°C"},{"key":"exit_temp_2h_after_start","label_he":"טמפ'' יציאה — שעתיים מתחילת פסטור","label_en":"Exit temperature — 2h after start","field_type":"temperature","required":false,"unit":"°C"},{"key":"corrective_action","label_he":"פעולה מתקנת","label_en":"Corrective action","field_type":"textarea","required":false},{"key":"dept_approver_sig","label_he":"שם וחתימת אישור מ. מחלקה","label_en":"Dept. manager approval name and signature","field_type":"name_and_signature","required":false}]}'::jsonb,
  false,
  NULL
)
ON CONFLICT (id) DO UPDATE SET
...
VALUES (
  ...
  NULL,
  'single_form'::public.input_mode,
  '{"input_mode":"single_form","fields":[{"key":"graph_verification","label_he":"אימות גרף","label_en":"Graph verification","field_type":"select","required":false,"options":["Approved","Not approved"]},{"key":"graph_image","label_he":"צילום גרף","label_en":"Graph photo","field_type":"image","required":false},{"key":"lab_manager_sig","label_he":"חתימת מנהלת המעבדה","label_en":"Laboratory manager signature","field_type":"name_and_signature","required":false}]}'::jsonb,
  false,
  '{"mode":"strict"}'::jsonb
)
ON CONFLICT (id) DO UPDATE SET
...
VALUES (
  ...
  NULL,
  'matrix'::public.input_mode,
  '{"input_mode":"matrix","columns":[{"key":"ultra_vessel","label_he":"מיכל אולטרה","label_en":"Ultra-clean vessel","field_type":"select","required":false,"options":["1","2"]},{"key":"product_temp_in_vessel","label_he":"טמפ'' המוצר במיכל (עד 4 מע\"צ)","label_en":"Product temp in vessel (up to 4 °C)","field_type":"temperature","required":false,"unit":"°C"},{"key":"status_ok","label_he":"תקין /לא תקין","label_en":"OK / not OK","field_type":"select","required":false,"options":["תקין","לא תקין"]},{"key":"lab_production_approval","label_he":"אישור מעבדה/מ. ייצור","label_en":"Lab / production approval","field_type":"text","required":false}]}'::jsonb,
  true,
  NULL
)
ON CONFLICT (id) DO UPDATE SET
...
VALUES (
  ...
  NULL,
  'single_form'::public.input_mode,
  '{"input_mode":"single_form","fields":[{"key":"corrective_action","label_he":"פעולה מתקנת","label_en":"Corrective action","field_type":"textarea","required":false},{"key":"lab_name_signature","label_he":"שם וחתימת מעבדה","label_en":"Lab name and signature","field_type":"name_and_signature","required":false}]}'::jsonb,
  false,
  NULL
)
ON CONFLICT (id) DO UPDATE SET
...
VALUES (
  ...
  NULL,
  'matrix'::public.input_mode,
  '{"input_mode":"matrix","columns":[{"key":"col_godel_ariza","label_he":"גודל אריזה","label_en":"Package size","field_type":"select","required":false,"options":["1","5","10","18","20","1000"]},{"key":"col_hataamat_ariza","label_he":"התאמת אריזה למוצר","label_en":"Package match to product","field_type":"select","required":false,"options":["כן","לא"]},{"key":"col_mispar_atsvot_balon","label_he":"מספר אצוות בלון גז","label_en":"Gas cylinder batch nos.","field_type":"text","required":false},{"key":"col_mispar_atsvot_sakit","label_he":"מספר אצוות שקית","label_en":"Bag batch nos.","field_type":"text","required":false},{"key":"col_mispar_atsvot_karton","label_he":"מספר אצוות קרטון","label_en":"Carton batch nos.","field_type":"text","required":false},{"key":"col_kamut_arizot","label_he":"כמות אריזות","label_en":"Number of packages","field_type":"number","required":false},{"key":"col_lishimush_ad","label_he":"לשימוש עד","label_en":"Use by","field_type":"date","required":false},{"key":"col_sahak_bekg","label_he":"סה\"כ בק\"ג","label_en":"Total (kg)","field_type":"number","required":false}]}'::jsonb,
  true,
  NULL
)
ON CONFLICT (id) DO UPDATE SET
...
VALUES (
  ...
  NULL,
  'single_form'::public.input_mode,
  '{"input_mode":"single_form","fields":[{"key":"verifier_name","label_he":"שם המאמת","label_en":"Verifier name","field_type":"text","required":false},{"key":"temp","label_he":"טמפ''","label_en":"Temperature","field_type":"temperature","required":false,"unit":"°C"},{"key":"weight","label_he":"משקל","label_en":"Weight","field_type":"number","required":false},{"key":"name_and_signature","label_he":"שם וחתימה","label_en":"Name and signature","field_type":"name_and_signature","required":false},{"key":"corrective_if_not_ok","label_he":"במידה ולא תקין – פעולה מתקנת","label_en":"If not OK — corrective action","field_type":"textarea","required":false}]}'::jsonb,
  false,
  '{"mode":"strict"}'::jsonb
)
ON CONFLICT (id) DO UPDATE SET
...
VALUES (
  ...
  NULL,
  'matrix'::public.input_mode,
  '{"input_mode":"matrix","columns":[{"key":"col_mispar_atsvot_karton","label_he":"מספר אצוות קרטון","label_en":"Carton batch nos.","field_type":"text","required":false},{"key":"col_ishur_hataama","label_he":"אישור התאמת אריזה למוצר","label_en":"Package fit approval","field_type":"select","required":false,"options":["כן","לא"]},{"key":"col_mispar_atsvot_balon","label_he":"מספר אצוות בלון גז","label_en":"Gas cylinder batch nos.","field_type":"text","required":false},{"key":"col_lishimush_ad","label_he":"לשימוש עד","label_en":"Use by","field_type":"date","required":false},{"key":"col_kamut","label_he":"כמות","label_en":"Quantity","field_type":"number","required":false},{"key":"col_sahak_bekg","label_he":"סה\"כ בק\"ג","label_en":"Total (kg)","field_type":"number","required":false}]}'::jsonb,
  true,
  NULL
)
ON CONFLICT (id) DO UPDATE SET
